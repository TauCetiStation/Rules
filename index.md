...
1. Носители импланта лояльности обязаны следовать [правилам отыгрыша персонажа с имплантом](https://wiki.taucetistation.org/Loyalty_Implant) - они не должны причинять вред корпорации и станции, они полностью лояльны политике НаноТрейзен и должны действовать в её интересах. Им также запрещено пытаться извлечь имплант самостоятельно или допускать его несанкционированное извлечение. От лоялистов ожидается соблюдение (насколько это позволяет ситуация)  внутренних процедур корпорации и космозакона, однако они могут уйти на второй план в исключительных случаях, уступая истинным интересам НаноТрейзен.
